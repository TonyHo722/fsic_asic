...
output wire por_l,
input wire rstb_h,
input wire clock_core,
output wire gpio_out_core,
input wire gpio_in_core,
output wire gpio_mode0_core,
output wire gpio_mode1_core,
output wire gpio_outenb_core,
output wire gpio_inenb_core,

    // Flash SPI communication
output wire flash_csb_frame,
output wire flash_clk_frame,
...
input wire flash_io1_di,
    ...
    // User project IOs
input wire [  `MPRJ_IO_PADS-1:0] mprj_io_in,
output wire [  `MPRJ_IO_PADS-1:0] mprj_io_out,
output wire [  `MPRJ_IO_PADS-1:0] mprj_io_oeb,
output wire [  `MPRJ_IO_PADS-1:0] mprj_io_inp_dis,
output wire [  `MPRJ_IO_PADS-1:0] mprj_io_ib_mode_sel,
output wire [  `MPRJ_IO_PADS-1:0] mprj_io_vtrip_sel,
output wire [  `MPRJ_IO_PADS-1:0] mprj_io_slow_sel,
output wire [  `MPRJ_IO_PADS-1:0] mprj_io_holdover,
output wire [  `MPRJ_IO_PADS-1:0] mprj_io_analog_en,
output wire [  `MPRJ_IO_PADS-1:0] mprj_io_analog_sel,
output wire [  `MPRJ_IO_PADS-1:0] mprj_io_analog_pol,
output wire [`MPRJ_IO_PADS*3-1:0] mprj_io_dm,

    // Loopbacks to constant value 1 in the 1.8V domain
output wire [`MPRJ_IO_PADS-1:0] mprj_io_one,
